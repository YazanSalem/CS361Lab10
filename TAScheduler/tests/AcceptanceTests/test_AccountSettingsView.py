...
class test_editUser(TestCase):
    ...
    def test_editPassword(self):
        self.client.post("/account_settings/",
                         {"userID": self.userToEdit.userID, "username": self.userToEdit.username, "password": "newpassword", "name": self.userToEdit.name,
                          "address": self.userToEdit.address, "phone": self.userToEdit.phone,
                          "email": self.userToEdit.email, "edit": ""})
    ...
    def test_editBlankPassword(self):
        ...
        resp = self.client.post("/account_settings/",
                         {"userID": self.userToEdit.userID, "username": self.userToEdit.username, "password": "", "name": self.userToEdit.name,
                          "address": self.userToEdit.address, "phone": self.userToEdit.phone,
                          "email": self.userToEdit.email, "edit": ""})
        ...
        self.assertEqual(password, self.userToEdit.password, "The user's password was edited when it shouldn't have been")

    def test_editName(self):
        self.client.post("/account_settings/",
                         {"userID": self.userToEdit.userID, "username": self.userToEdit.username, "password": self.userToEdit.password, "name": "new name",
                          "address": self.userToEdit.address, "phone": self.userToEdit.phone,
                          "email": self.userToEdit.email, "edit": ""})
    ...
    def test_editBlankName(self):
        ...
        resp = self.client.post("/account_settings/",
                         {"userID": self.userToEdit.userID, "username": self.userToEdit.username, "password": self.userToEdit.password, "name": "",
                          "address": self.userToEdit.address, "phone": self.userToEdit.phone,
                          "email": self.userToEdit.email, "edit": ""})
    ...
    def test_editAddress(self):
        self.client.post("/account_settings/",
                         {"userID": self.userToEdit.userID, "username": self.userToEdit.username, "password": self.userToEdit.password, "name": self.userToEdit.name,
